/******************************************************************************
 * 
 * File Name     : UserActivityHook.cs
 * Description   : This is the code download from the internet which includes the *mouse and keyboard event.
*
 *
 ******************************************************************************/
...
namespace VOIPTextToSpeechVAC.Base.UserActivityHook  
{
